...
# Importar plyer para funcionalidades móviles
try:
        ...
        if 0 <= indice < len(self.medicamentos):
            ...
            if not ya_completado:
                ...
                if winsound:
                    ...
                    try:
                        # Vibración de celebración para Android
    ...
    def verificar_dia_completado(self):
        ...
        if todos_completados:
            ...
            if winsound:
                ...
                try:
                    # Vibración especial de celebración completa para Android
                    for _ in range(3):
                        vibrator.vibrate(0.3)
                        time.sleep(0.2)
                except:
    ...
    def completar_todos_medicamentos(self):
        ...
        if completados > 0:
            ...
            if winsound:
                ...
                try:
                    # Vibración especial para completar todos en Android
                    for _ in range(3):
                        vibrator.vibrate(0.3)
                        time.sleep(0.2)
                except:
